...
const Page = () => {
  return (
    <div>
        ...
        <div>
       <Image src="/Images/cartimage.png" alt="cartimage"/>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-[#fff9e5] p-6 rounded-lg shadow">
            ...
            <div className="space-y-4">
              ...
              <button className="w-full  px-4 py-2 bg-[#fff9e5] font-medium rounded-lg shadow hover:bg-white text-black transition">
                Proceed to Checkout
              </button>
            </div>
          </div>
